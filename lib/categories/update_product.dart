...
import 'package:online_clothing_admin/utils/global_variables.dart';
...
class UpdateProductState extends State<UpdateProduct> {
  ...
  void initState() {
    super.initState();
    getAllCategories();
    productNameCtl.text = widget.cartMap['product_name'];
    shortDescriptionCtl.text = widget.cartMap['short_description'];
    longDescriptionCtl.text = widget.cartMap['long_description'];
    cutPriceCtl.text = "${widget.cartMap['cut_price']}";
    salePriceCtl.text = "${widget.cartMap['sale_price']}";
    selectedCategoryName = "${widget.cartMap['category']}";
    isFeaturedValue = "${widget.cartMap['is_featured']}";
    isAvailableValue = "${widget.cartMap['is_available']}";
  }
  ...
  Future updateData(BuildContext context) async {
    ...
    productInfo['is_available'] = isAvailableValue;
    productInfo['is_featured'] = isFeaturedValue;
    ...
    return collection
        ...
        .update(productInfo)
        .then((value) => successDialog(productNameCtl.text, context))
        .catchError((error) => errorDialog(context,"Failed to update product: $error",''));
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            featuredOrNot(context),
            availableOrNot(context),
  ...
  featuredOrNot(BuildContext context){
    return Container(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            onTap: (){
              isFeaturedValue = '0';
              debugPrint(isFeaturedValue);
              updateFeatured(isFeaturedValue, context);
            },
            child: Container(
              ...
              child: Align(
                ...
                child: Padding(
                  ...
                  child: myText(context, "Remove Featured", ColorsX.white, 0, 0, 0, 0, FontWeight.w600, 17),
                ),
              ),
            ),
          ),
          GestureDetector(
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: 5.0),
                  child: myText(context, "Make Featured", ColorsX.white, 0, 0, 0, 0, FontWeight.w600, 17),
                ),
              ),
            ),
          ),
  ...
  availableOrNot(BuildContext context){
    return Container(
        ...
        children: [
          GestureDetector(
            onTap: (){
              setState(() {
                isAvailableValue = '0';
                updateAvailability(isAvailableValue, context);
              });
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: 5.0),
                  child: myText(context, "Out of Stock", ColorsX.white, 0, 0, 0, 0, FontWeight.w600, 17),
                ),
              ),
            ),
          ),
          GestureDetector(
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: 5.0),
                  child: myText(context, "Available", ColorsX.white, 0, 0, 0, 0, FontWeight.w600, 17),
                ),
              ),
            ),
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(vertical: 15.0),
            child: myText(context, "Update Product", ColorsX.white, 0, 0, 0, 0, FontWeight.w600, 17),
          ),
        ),
      ),
    );
  ...
  Future<void> updateFeatured(String? isFeaturedValue, BuildContext context) async {
    GlobalWidgets.showProgressLoader("Please wait");
    CollectionReference users =  FirebaseFirestore.instance.collection('products');
     await users
          .doc(GlobalVariables.idOfProduct)
          .update({'is_featured': isFeaturedValue})
         .then((value) => successDialog(productNameCtl.text, context))
         .catchError((error) => errorDialog(context,"Failed to update product: $error",''));
  }

  Future<void> updateAvailability(String? isAvailableValue, BuildContext context) async {
    GlobalWidgets.showProgressLoader("Please wait");
    CollectionReference users =  FirebaseFirestore.instance.collection('products');
     await users
          .doc(GlobalVariables.idOfProduct)
          .update({'is_available': isAvailableValue})
         .then((value) => successDialog(productNameCtl.text, context))
         .catchError((error) => errorDialog(context,"Failed to update product: $error",''));
  }
}