...
import '../../../widget/intro_pages.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageView(
        children: <Widget>[
          IntroScreenPageOne(
            imagePath: 'assets/images/wedding_five.png',
          ...
          IntroScreenPageOne(
            imagePath: 'assets/images/wedding_three.png',
          ...
          IntroScreenPageOne(
            imagePath: 'assets/images/wedding_four.png',
