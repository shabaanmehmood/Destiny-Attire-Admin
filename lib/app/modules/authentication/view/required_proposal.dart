...
class RequiredProposal extends StatefulWidget {
  const RequiredProposal({Key? key}) : super(key: key);

  @override
  _RequiredProposalState createState() => _RequiredProposalState();
}

class _RequiredProposalState extends State<RequiredProposal> {
  ...
  getHeight(BuildContext context, TextEditingController feetCtl,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Expanded(child: globalWidgets.myTextField(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: selectedTypeOfHousing.contains(poshArea) ? ColorsX
                        .light_orange : Colors.transparent,
                  ),
                  child: Column(
          ...
          text: TextSpan(
              children: [
                TextSpan(
                  ...
                  style: TextStyle(color: ColorsX.white, fontSize: 16),
                ),
                TextSpan(
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: new InputDecoration(
            ...
            hintText: hint,
            hintStyle: TextStyle(color: ColorsX.white)
        ),
      ),
    );
  }
    ...
    return GestureDetector(
      onTap: () {
        if (!isCasteSpecificSelected && !isAnyCasteSelected) {
          ...
          print(GlobalVariables.housing_demand_in);
          print(GlobalVariables.housing_demand_area);
  ...
  void createAccount(BuildContext context) async {
    ...
    userInfo['secondary_phone'] = GlobalVariables.primary_phone;
