...
class ProposalDetailModel {
  ...
  factory ProposalDetailModel.fromJson(Map<String, dynamic> json) => ProposalDetailModel(
    serverResponse: ServerResponse.fromJson(json["server_response"]),
  );

  Map<String, dynamic> toJson() => {
    "server_response": serverResponse.toJson(),
  };
}
