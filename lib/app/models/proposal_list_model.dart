...
ProposalListModel proposalListModelFromJson(String str) => ProposalListModel.fromJson(json.decode(str));

String proposalListModelToJson(ProposalListModel data) => json.encode(data.toJson());
...
class ProposalListModel {
  ...
  factory ProposalListModel.fromJson(Map<String, dynamic> json) => ProposalListModel(
